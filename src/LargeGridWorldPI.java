...
public class LargeGridWorldPI {
	...
	public static void main(String[] args) {
		...
		LargeGridWorldPI example = new LargeGridWorldPI();
	...
	public LargeGridWorldPI(){
		...
		GridWorldDomain.setLocation(initialState, 0, 95, 95);
