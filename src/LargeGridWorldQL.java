...
public class LargeGridWorldQL {
	...
	public static void main(String[] args) {
		...
		LargeGridWorldQL example = new LargeGridWorldQL();
		String outputPath = "output/"; 
		
		
		//run policy iteration  on the grid world domain
	...
	public LargeGridWorldQL(){
	
		//create the domain
		gwdg = new GridWorldDomain(50, 50);
		//gwdg.setProbSucceedTransitionDynamics(0.95); //stochastic transitions with 0.8 success rate
		gwdg.verticalWall(5, 45, 45);
		gwdg.horizontalWall(5, 45, 45);
		...
		GridWorldDomain.setLocation(initialState, 0, 47, 47);
	...
	public void QLearningExample(String outputPath){
		...
		LearningAgent agent = new QLearning(domain, rf, tf, 0.1, hashingFactory, 0., 0.9);
